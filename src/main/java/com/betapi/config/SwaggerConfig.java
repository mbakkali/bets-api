...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.betapi.controllers"))
    ...
    private ApiInfo getApiInformation(){
        return new ApiInfo("Bets-api REST API",
                "Automation of bets",
                "1.0",
                "API Terms of Service URL",
                new Contact("Progressive Coder", "www.parishaitiens.com", "mehdi.bakkali.94@gmail.com"),
                "API License",
                "API License URL",
